...
import createVendeeExternalProceedAction, {
  updateVendeeExternalProceedAction,
} from "@/actions/vendeeExternalProceedAction";
...
export function ExternalProceedModal({
  ...
  function submiteForm(newData) {
    ...
    startTransition(async () => {
      if (type === "create") {
        const result = await createVendeeExternalProceedAction(myNewData);
        if (!result.err) {
      ...
      if (type === "update") {
        ...
        const result = await updateVendeeExternalProceedAction(
          currentData,
          myNewData
        );
        if (!result.err) {
