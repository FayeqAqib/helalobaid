...
function SidebarMenuItem({ className, noList = true, ...props }) {
  const { toggleSidebar, isMobile } = useSidebar();
  return (
    <li
      data-slot="sidebar-menu-item"
      data-sidebar="menu-item"
      onClick={isMobile && noList ? toggleSidebar : undefined}
...
function SidebarMenuSub({ className, ...props }) {
  return (
    <ul
      ...
      className={cn(
        "border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-1  border-r-2 px-2.5 py-0.5",
        "group-data-[collapsible=icon]:hidden",
        className
      )}
      {...props}
...
const SidebarChildren = ({ children, fn }) => {
