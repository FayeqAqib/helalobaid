...
export const columns = [
...

  {
    ...
    cell: ({ row }) => <div className="lowercase">{row.getValue("lord")}</div>,
  },
  {
  ...
  },
  {
    accessorKey: "image",
    header: ({ column }) => {
      return <Button variant="ghost">آواتار</Button>;
    },
    cell: ({ row }) => {
      ...
      return (
        <div className="lowercase">
          <Avatar>
            ...
            <AvatarFallback>
              <span className="uppercase">{name.slice(0, 2)}</span>
            </AvatarFallback>
          </Avatar>
        </div>
      );
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const [openCreateDepot, setOpenCreateDepot] = useState(false);
      ...
      return (
        <CreateDepotModal
          ...
          data={payment}
          type="update"
          open={openCreateDepot}
          onOpen={setOpenCreateDepot}
        >
          <ConfirmDelete
            data={payment}
            open={openDelete}
                ...
                <DropdownMenuContent>
                  ...
                  >
                    <Button
                      onClick={() =>
                        setOpenCreateDepot(
                          (openCreateDepot) => !openCreateDepot
                        )
                      }
                      variant={"ghost"}
                      className={"w-full justify-end"}
...
export function DataTableCreateDepot({ data, count }) {
    ...
    <div className="w-full">
      <div className="flex items-stretch flex-col md:flex-row justify-between py-4 gap-3">
        ...
        <div className="flex gap-4">
          ...
          <CreateDepotModal open={open} onOpen={setOpen}>
            <DialogTrigger asChild>
              <Button>
                افزودن گدام <HiCurrencyRupee className="size-6" />
              </Button>
            </DialogTrigger>
          </CreateDepotModal>
        </div>
