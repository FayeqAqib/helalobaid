    ...
    <Card className={"p-3 shadow-lg grid max-w-[160px] gap-1  w-full "}>
      <CardHeader className={"text-right flex flex-row justify-between p-0"}>
        <div className="flex flex-row items-center justify-center gap-2">
          <img src="../total-earn.svg" className="w-9 h-9" />
      ...
      >
        <div className="flex flex-row gap-1 mx-1  bg-[var(--card-foreground)] rounded-xl shadow-xl w-full  p-1 ">
          <CardDescription
            className={
              "flex flex-row justify-around text-[var(--card)] items-center gap-x-2"
            }
          >
            <svg
              width="16"
            ...
            <CardTitle className={"text-sm font-extrabold"}>موجود</CardTitle>
            <CardTitle className={"text-sm font-bold"}>
              {formatNumber(balance || 0)}
            </CardTitle>
          </CardDescription>
        </div>
        <div className="flex flex-row gap-2 mx-1 bg-[var(--chart-2)] rounded-xl shadow-xl w-full  p-1 ">
          <CardDescription
            className={
          ...
          >
            ...
            <CardTitle className={"text-sm font-extrabold"}> خرید</CardTitle>
            <CardTitle className={"text-sm font-bold"}>
              {formatNumber(buy || 0)}
            </CardTitle>
          </CardDescription>
        ...
        <div className="flex flex-row gap-2 mx-1   bg-[var(--chart-2)] rounded-xl shadow-xl w-full  p-1 ">
          ...
          >
            ...
            <CardTitle className={"text-sm font-extrabold"}>فروش</CardTitle>
            <CardTitle className={"text-sm font-bold"}>
              {formatNumber(sale || 0)}
            </CardTitle>
          </CardDescription>
