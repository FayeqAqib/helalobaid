...
import { ExternalProceedModal } from "./ExternalProceedModal";
import { DatePickerWithPresets } from "@/components/myUI/datePacker";
import { usePathname, useRouter } from "next/navigation";
import ConfirmDelete from "./ConfirmDelete";
import { DialogTrigger } from "@radix-ui/react-dialog";
import { formatCurrency } from "@/lib/utils";
import { HiCurrencyDollar, HiOutlineArchiveBox } from "react-icons/hi2";
...
//     id: "m5gr84i9",
//     date: "2024/5/3",
//     externalProceedTitle: "احمد",
//     amount: 3000,
//     details: "قروش 100 افغنی کریدت",
//   },
//   {
//     id: "m5gr84i9",
//     date: "2024/5/3",
...
export const columns = [
  ...
  {
    accessorKey: "externalProceedTitle",
    header: ({ column }) => {
      return (
        <Button
          variant="ghost"
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const [openExternalProceed, setOpenExternalProceed] = useState(false);
      return (
        <ExternalProceedModal
          key={openExternalProceed}
          data={payment}
          type="update"
          open={openExternalProceed}
          onOpen={setOpenExternalProceed}
        >
          <ConfirmDelete
            data={payment}
            open={openDelete}
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent>
                ...
                >
                  <Button
                    onClick={() =>
                      setOpenExternalProceed(
                        (openExternalProceed) => !openExternalProceed
                      )
                    }
                    variant={"ghost"}
...
export function DataTableExternalProceed({ data, count }) {
    ...
    <div className="w-full">
      <div className="flex items-stretch flex-col md:flex-row justify-between py-4 gap-3">
        ...
        <div className="flex gap-4">
          ...
          <ExternalProceedModal open={open} onOpen={setOpen}>
            <DialogTrigger asChild>
              <Button>
                افزودن عواید <HiCurrencyDollar className="size-6" />
              </Button>
            </DialogTrigger>
          </ExternalProceedModal>
        </div>
