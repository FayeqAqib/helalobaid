...
import { ProceedTitalModal, ProductModal } from "./ProceedTitalModal";
...
export const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const [openProceedTital, setOpenProceedTital] = useState(false);
      const [openDetails, setOpenDetails] = useState(false);
      return (
        <ProceedTitalModal
          key={openProceedTital}
          data={payment}
          type="update"
          open={openProceedTital}
          onOpen={setOpenProceedTital}
        >
          <ConfirmDelete
            data={payment}
            open={openDelete}
                    ...
                    <>
                      ...
                      >
                        <Button
                          onClick={() =>
                            setOpenProceedTital(
                              (openProceedTital) => !openProceedTital
                            )
                          }
                          variant={"ghost"}
                          className={"w-full justify-end"}
...
export function DataTableProceedTital({ data, count }) {
    ...
    <div className="w-full">
      <div className="flex items-stretch flex-col md:flex-row justify-between py-4 gap-3">
        ...
        <div className="flex gap-4">
          ...
          <ProceedTitalModal open={open} onOpen={setOpen}>
            <DialogTrigger asChild>
              <Button>کتگوری جدید</Button>
            </DialogTrigger>
          </ProceedTitalModal>
        </div>
      </div>
