...
import { CostTitalModal, ProductModal } from "./CostTitalModal";
...
export const columns = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const [openCostTital, setOpenCostTital] = useState(false);
                  ...
                  {payment.accountType === "company" ? (
                    ...
                    <>
                      ...
                      >
                        <Button
                          onClick={() =>
                            setOpenCostTital((openCostTital) => !openCostTital)
                          }
                          variant={"ghost"}
                          className={"w-full justify-end"}
                        >
...
export function DataTableCostTital({ data, count }) {
    ...
    <div className="w-full">
      <div className="flex items-stretch flex-col md:flex-row justify-between py-4 gap-3">
        ...
        <div className="flex gap-4">
          ...
          <CostTitalModal open={open} onOpen={setOpen}>
            <DialogTrigger asChild>
              <Button>
                کتگوری مصارف جدید <HiUserPlus className="size-6" />
              </Button>
            </DialogTrigger>
          </CostTitalModal>
        </div>
